...
final public class JY_ShimmeringView: UIView {

    override public class var layerClass: Swift.AnyClass {
        return JY_ShimmeringLayer.self
    }
    ...
    private var shimmerLayer: JY_ShimmeringLayer? {
        return (layer as? JY_ShimmeringLayer)
    }
