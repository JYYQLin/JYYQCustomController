//
//  JY_Driving_Test_Essentials_Introduction_View.swift
...
class JY_Driving_Test_Essentials_Introduction_View: JY_View {
    ...
    private lazy var yq_collectionView: UICollectionView = {
        ...
        view.register(JY_Driving_Test_Essentials_Introduction_Style1_Cell.self, forCellWithReuseIdentifier: JY_Driving_Test_Essentials_Introduction_Style1_Cell.yq_ID())
        view.register(JY_Driving_Test_Essentials_Introduction_Style2_Cell.self, forCellWithReuseIdentifier: JY_Driving_Test_Essentials_Introduction_Style2_Cell.yq_ID())
...
extension JY_Driving_Test_Essentials_Introduction_View {
...
extension JY_Driving_Test_Essentials_Introduction_View: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 {
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: JY_Driving_Test_Essentials_Introduction_Style1_Cell.yq_ID(), for: indexPath) as? JY_Driving_Test_Essentials_Introduction_Style1_Cell else {
                return JY_Driving_Test_Essentials_Introduction_Style1_Cell()
            }
            ...
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: JY_Driving_Test_Essentials_Introduction_Style2_Cell.yq_ID(), for: indexPath) as? JY_Driving_Test_Essentials_Introduction_Style2_Cell else {
                return JY_Driving_Test_Essentials_Introduction_Style2_Cell()
            }
...
extension JY_Driving_Test_Essentials_Introduction_View: UICollectionViewDelegate {
    
}

extension JY_Driving_Test_Essentials_Introduction_View: UICollectionViewDelegateFlowLayout {
