//
//  JY_Driving_Test_Essentials_NavigationBar.swift
...
class JY_Driving_Test_Essentials_NavigationBar: JY_View {

    private lazy var yq_title_imageView: JY_ImageView = JY_ImageView()

}

extension JY_Driving_Test_Essentials_NavigationBar {
