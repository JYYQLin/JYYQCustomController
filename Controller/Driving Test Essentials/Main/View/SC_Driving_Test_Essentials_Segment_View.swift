//
//  JY_Driving_Test_Essentials_Segment_View.swift
...
class JY_Driving_Test_Essentials_Segment_View: JY_View {
    
    var yq_title_click_block: ((_ index: Int) -> Void)?
    
    private lazy var yq_segment_view: JY_Driving_Test_Essentials_Segment_Control = {
        let view = JY_Driving_Test_Essentials_Segment_Control()
...
extension JY_Driving_Test_Essentials_Segment_View {
